...
class MyBertSelfAttention(BertSelfAttention):
    def __init__(self,config,domain_token_ids=None, boost_factor=2.0):
...
class MyBertLayer(BertLayer):
    def __init__(self, config, domain_token_ids, boost_factor):
        super().__init__(config)
        # SelfAttention
        self.attention.self = MyBertSelfAttention(
            config, domain_token_ids=domain_token_ids, boost_factor=boost_factor
        )
...
class MyBertEncoder(BertEncoder):
    def __init__(self, config, domain_token_ids, boost_factor):
        ...
        self.layer = nn.ModuleList(
            [MyBertLayer(config, domain_token_ids, boost_factor)
...
class MyBertModel(BertModel):
    def __init__(self, config, domain_token_ids, boost_factor):
        super().__init__(config)
        self.encoder = MyBertEncoder(config, domain_token_ids, boost_factor)
...
class MyBertForSequenceClassification(BertForSequenceClassification):
    def __init__(self, config, domain_token_ids, boost_factor):
        super().__init__(config)
        self.bert = MyBertModel(config, domain_token_ids, boost_factor)
